...
function (mmdeploy_add_library NAME)
    ...
    if (MMDEPLOY_MONOLITHIC)
        set(_MAYBE_TYPE OBJECT)
    elseif (NOT (_TYPE_STATIC OR _TYPE_SHARED OR _TYPE_MODULE))
    ...
    if (MMDEPLOY_MONOLITHIC)
        set(GLOBAL_OBJ ${GLOBAL_OBJ} ${NAME} CACHE INTERNAL "")
        mmdeploy_export(${NAME})
    elseif (NOT _MMDEPLOY_EXCLUDE)
...
function (mmdeploy_add_module NAME)
    ...
    if (MMDEPLOY_MONOLITHIC AND (NOT _TYPE_MODULE))
        set(_MAYBE_TYPE OBJECT)
    elseif (NOT (_TYPE_STATIC OR _TYPE_SHARED OR _TYPE_MODULE))
    ...
    if ((_TYPE STREQUAL STATIC_LIBRARY) OR (_TYPE STREQUAL OBJECT_LIBRARY))
        ...
        if (NOT (_MMDEPLOY_EXCLUDE OR MMDEPLOY_MONOLITHIC))
